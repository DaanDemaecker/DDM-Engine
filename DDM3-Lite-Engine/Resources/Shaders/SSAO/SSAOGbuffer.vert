...
layout(location = 6) out vec4 viewPos;
...
void main()
{
    ...
    // FragColor, UV's and UvSetINdex should be the same as input
    fragColor = inColor;
    ...
    viewPos = ubo.view * ubo.model * vec4(inPosition, 1.0);
    
    //mat3 modelView = ubo.view * ubo.model;
