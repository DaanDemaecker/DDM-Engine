...
void DDM::BufferCreator::CopyBuffer(DDM::GPUObject* pGPUObject, DDM::CommandpoolManager* pCommandPoolManager, VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size)
{
...
void DDM::BufferCreator::CreateVertexBuffer(DDM::GPUObject* pGPUObject, DDM::CommandpoolManager* pCommandPoolManager, std::vector<DDM::Vertex>& vertices, VkBuffer& vertexBuffer, VkDeviceMemory& vertexBufferMemory)
{
	auto device{ pGPUObject->GetDevice() };

	// Calculate buffer size for vertices
	VkDeviceSize bufferSize = sizeof(DDM::Vertex) * vertices.size();
...
void DDM::BufferCreator::CreateIndexBuffer(DDM::GPUObject* pGPUObject, DDM::CommandpoolManager* pCommandPoolManager, std::vector<uint32_t>& indices, VkBuffer& indexBuffer, VkDeviceMemory& indexBufferMemory)
{
	auto device{ pGPUObject->GetDevice() };
