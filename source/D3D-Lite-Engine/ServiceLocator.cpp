...
std::unique_ptr<D3D::DefaultModelLoader> D3D::ServiceLocator::m_DefaultSoundSystemInstance{ std::make_unique<D3D::DefaultModelLoader>() };
...
{
    return m_pModelLoaderInstance.get() == nullptr ? *m_pModelLoaderInstance.get() : *m_pModelLoaderInstance.get();
}
